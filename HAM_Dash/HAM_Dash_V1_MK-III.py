...
def menuDTMF():
    ...
    menuDTMF.attributes('-fullscreen', True)
    ...
    #
    #---------------------------------------------------------------------------------------------------- Back Button
    button5099=Button(menuDTMF,text='BACK',font=('Helvetica','12'),width=16,height=2,bg="blue2",fg="gray1",command=menuDTMFExit)
...
def creditsScreen():
    ...
    creditsScreen.configure(background="yellow")
    #------------------------------------------------------------------------------------------------------------------------------------------------------------- Page Background
...
def menuSOS():
    ...
    menuSOS.configure(background="gray5")
    #------------------------------------------------------------------------------------------------------------------------------------------------------------- Page Background
    label0101=Label(menuSOS, image=photo10001)
    ...
    button0199=Button(menuSOS,text='BACK',font=('Helvetica','12'),width=16,height=2,bg="blue2",fg="gray1",command=menuSOSExit)
