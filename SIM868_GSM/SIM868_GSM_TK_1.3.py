...
from tkinter import *
'''
# V1.1 = Impliment TK and SMS send. --------------------------- == MET
# V1.2 = Impliment Place and End Call. ------------------------ == MET
# V1.3 = Impliment Message Read in Console. ------------------- == MET
# V1.4 = Impliment Change Recipient by Input. ----------------- != MET
# V1.5 = Impliment Change Recipient by Phonebook. ------------- != MET
# V1.6 = Impliment Change Message by Input. ------------------- != MET
# V1.7 = Impliment Auto Respond and Command via Incoming. ----- != MET
# V1.8 = Impliment Data Connection. --------------------------- != MET
# V1.9 = Impliment DTMF Responses (DTMF Decoder Chip). -------- != MET
# V1.10 = Impliment 3 Way Calling. ---------------------------- != MET
'''
runOnce = True
rootTitle = "SIM868 Full V1.3"
